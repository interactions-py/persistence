...
class Cipher:
    ...
    def __init__(self, key=None):
        ...
        if not key:
            print("It is highly recommended to provide a key using the cipher_key kwarg in bot.load. If you do not, a random key will be generated. Check the docs for more information.")
            key = generate_key()
            print("Your autogenerated key is: " + key)
